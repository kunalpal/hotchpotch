  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: 'p-0 size-8 text-sm flex-1 flex items-center justify-center has-[button]:hover:!bg-primary rounded-md has-[button]:hover:aria-selected:!bg-primary has-[button]:hover:text-primary-foreground has-[button]:hover:aria-selected:text-primary-foreground',
        day_button: cn(
        ...
        range_middle:
          'aria-selected:bg-primary hover:aria-selected:!bg-primary rounded-none aria-selected:text-primary-foreground hover:aria-selected:text-primary-foreground',
        hidden: 'invisible',
        ...classNames,
      }}
      components={{
